...
sv_integer arf(const sv_line&, const sv_primitive&, sv_interval, 
    sv_real, const sv_integer, double *);
void arf_r(const sv_line&, const sv_primitive&, sv_interval, sv_real);
